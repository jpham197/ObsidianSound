document.addEventListener('keydown', function () {
	...
	if (event.keyCode == 104 || event.keyCode == 72) { // this is h
			document.getElementById("Doodlebob sound effect").play();
	...
	//*****************We need more audio files for this row of buttons *************************
...
document.addEventListener('keyup', function () {
	...
	if (event.keyCode == 104 || event.keyCode == 72) { // this is h
			document.getElementById("Doodlebob sound effect").load();
			document.getElementById("Doodlebob sound effect").play();
